...
import {
  Code, Briefcase, FlaskConical, Palette,
  Laptop, HeartPulse, Building, BookOpen
} from 'lucide-react';
import './CareerExploration.css'; // Import traditional CSS
...
const CareerExploration = () => {
  ...
  return (
    <div ref={sectionRef} className="career-exploration-section">
      <h2 ref={headingRef} className="career-heading">Career Exploration</h2>
      <div ref={cardsRef} className="career-card-grid">
